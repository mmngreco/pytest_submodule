...
htmlhelp_basename = 'pytest_submodule-doc'
...
latex_documents = [
    (master_doc, 'pytest_submodule.tex', 'pytest_submodule Documentation',
     'COM', 'manual'),
]
...
man_pages = [
    (master_doc, 'pytest_submodule', 'pytest_submodule Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pytest_submodule', 'pytest_submodule Documentation',
     author, 'pytest_submodule', 'One line description of project.',
     'Miscellaneous'),
]
